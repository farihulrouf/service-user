(function (global, factory) {
	...
	var array = function (ref, path, context) {
		...
		if (schema.items != null) {
			...
			var innerSource = 'arr[i] = context.fn[%%INDEX%%](arr[i], (parentField ? parentField : "") + "[" + i + "]", parent, errors, context)';
	...
	var object = function (ref, path, context) {
		...
		if (subSchema) {
			...
			for (var i = 0; i < keys.length; i++) {
				...
				var innerSource = "\n\t\t\t\t" + safePropName + " = context.fn[%%INDEX%%](value, field, parentObj, errors, context);\n\t\t\t";
	...
	var PATTERN$1 = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-6][0-9a-f]{3}-[0-9a-f]{4}-[0-9a-f]{12}$/i;
